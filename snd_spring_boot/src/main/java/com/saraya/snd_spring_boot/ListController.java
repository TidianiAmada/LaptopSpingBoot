package com.saraya.snd_spring_boot;
...
public class ListController {
	...
	public String fstApp(ModelMap model) {
		...
		List<Laptop> laptops = laptopservice.retrieveAll();
...
//		}
		...
		laptopservice.update(previous_id,laptop.getDescription(),laptop.getPicture());
		model.clear();
		return "redirect:/list";
	}
}